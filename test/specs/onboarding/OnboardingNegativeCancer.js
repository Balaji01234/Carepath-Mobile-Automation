...
describe('Carepath Automation', () => {
    ...
    it.only('TC-003-NewUserOnboardingCancer', async () => {
        try {
            ...
            await Keywords.verifyElementDisplayed(Locatoronboard.pain, "pain");
            await Keywords.verifyText(Locatoronboard.painval, "content-desc", "Pain", "Pain")
            await Keywords.click(Locatoronboard.fifthNumber, " 5 Button");
            await Keywords.verifyElementIsEnabled(Locatoronboard.cancerNext, "Next  Button")
            await Keywords.click(Locatoronboard.cancerNext, " Next Button");
            await Keywords.verifyElementDisplayed(Locatoronboard.completeStatus(74), "74% complete status");
            await Keywords.verifyElementDisplayed(Locatoronboard.Tiredness, "Tiredness");
            await Keywords.verifyText(Locatoronboard.tirednessval, "content-desc", "Tiredness", "Tiredness");
            await Keywords.click(Locatoronboard.seven, " seven Button");
            await Keywords.verifyElementIsEnabled(Locatoronboard.cancerNext, "Next  Button")
            await Keywords.click(Locatoronboard.cancerNext, " Next Button");
            await Keywords.verifyElementDisplayed(Locatoronboard.completeStatus(76), "76% complete status");
            await Keywords.verifyElementDisplayed(Locatoronboard.Drowsiness, "Drowsiness");
            await Keywords.verifyText(Locatoronboard.drowsinessval, "content-desc", "Drowsiness", "Drowsiness"); 
            await Keywords.click(Locatoronboard.nine, " Nine Button");
            await Keywords.verifyElementIsEnabled(Locatoronboard.cancerNext, "Next  Button")
            await Keywords.click(Locatoronboard.cancerNext, " Next Button");
            await Keywords.verifyElementDisplayed(Locatoronboard.completeStatus(79), "79% complete status");
            await Keywords.verifyElementDisplayed(Locatoronboard.nausea, "nausea");
            await Keywords.verifyText(Locatoronboard.nauseaval, "content-desc", "Nausea", "Nausea"); 
            await Keywords.click(Locatoronboard.two, "Second Button");
            await Keywords.verifyElementIsEnabled(Locatoronboard.cancerNext, "Next  Button")
            await Keywords.click(Locatoronboard.cancerNext, " Next Button");
            await Keywords.verifyElementDisplayed(Locatoronboard.completeStatus(81), "81% complete status");
            await Keywords.verifyElementDisplayed(Locatoronboard.lackofappetite, "lackofappetite");
            await Keywords.verifyText(Locatoronboard.lackofappetiteVal, "content-desc", "Lack of Appetite", "Lack of Appetite Text")
            await Keywords.click(Locatoronboard.three, "Three Button");
            await Keywords.verifyElementIsEnabled(Locatoronboard.cancerNext, "Next  Button")
            await Keywords.click(Locatoronboard.cancerNext, " Next Button");
            await Keywords.verifyElementDisplayed(Locatoronboard.completeStatus(83), "83% complete status");
            await Keywords.verifyElementDisplayed(Locatoronboard.shortnessval, "shortness");
            await Keywords.verifyText(Locatoronboard.shortness, "content-desc", "Shortness of Breath", "Shortness of Breath")
            await Keywords.click(Locatoronboard.three, "Three Button");
            await Keywords.verifyElementIsEnabled(Locatoronboard.cancerNext, "Next  Button")
            await Keywords.click(Locatoronboard.cancerNext, " Next Button");
            await Keywords.verifyElementDisplayed(Locatoronboard.completeStatus(86), "86% complete status");
            await Keywords.verifyElementDisplayed(Locatoronboard.depressionval, "Depression");
            await Keywords.verifyText(Locatoronboard.depression, "content-desc", "Depression", "Depression");
            await Keywords.click(Locatoronboard.two, "Second Button");
            await Keywords.verifyElementIsEnabled(Locatoronboard.cancerNext, "Next  Button")
            await Keywords.click(Locatoronboard.cancerNext, " Next Button");
            await Keywords.verifyElementDisplayed(Locatoronboard.completeStatus(88), "88% complete status");
            await Keywords.verifyElementDisplayed(Locatoronboard.anxietyval, "Anxiety");
            await Keywords.verifyText(Locatoronboard.anxiety, "content-desc", "Anxiety", "Anxiety");
            await Keywords.click(Locatoronboard.seven, " seven Button");
            await Keywords.verifyElementIsEnabled(Locatoronboard.cancerNext, "Next  Button")
            await Keywords.click(Locatoronboard.cancerNext, " Next Button");
            await Keywords.verifyElementDisplayed(Locatoronboard.completeStatus(90), "90% complete status");
            await Keywords.verifyElementDisplayed(Locatoronboard.wellbeingval, "Wellbeing");
            await Keywords.verifyText(Locatoronboard.wellbeing, "content-desc", "Wellbeing", "Wellbeing");
            await Keywords.click(Locatoronboard.nine, " Nine Button");
            await Keywords.verifyElementIsEnabled(Locatoronboard.saveSEAEOption, "SAVE ESAS-R  Button");
            await Keywords.click(Locatoronboard.saveSEAEOption, "SAVE ESAS-R  Button");
            ...
            const personalInfo1 = await Keywords.getattribute(Locatoronboard.painField,"content-desc","5")
            await Keywords.verifyElementDisplayed(Locatoronboard.personalInformation(painField), "Pain Field"); 
          
            const TirednessField = await readData("TC_02", "Field", "Tiredness", "Testdata1");
            const TirednessField1 = await Keywords.getattribute(Locatoronboard.TirednessFieldOpt,"content-desc","7")
            await Keywords.verifyElementDisplayed(Locatoronboard.personalInformation(TirednessField), "Tiredness Field")
         
            const DrowsinessField = await readData("TC_02", "Field", "Drowsiness", "Testdata1");
            const personalInfo3 = await Keywords.getattribute(Locatoronboard.DrowsinessField,"content-desc","9")
            await Keywords.verifyElementDisplayed(Locatoronboard.personalInformation(DrowsinessField), "Drowsiness Field");
            await Keywords.scrollToElement("accessibility id","CANCEL");
            const Nauseafi = await readData("TC_02", "Field", "Nausea", "Testdata1");
            const personalInfo4 = await Keywords.getattribute(Locatoronboard.NauseaField,"content-desc","2")
            await Keywords.verifyElementDisplayed(Locatoronboard.personalInformation(Nauseafi), "Nausea Field");
            await Keywords.scrollToElement("accessibility id","CANCEL");
            const LackofAppetite = await readData("TC_02", "Field", "Appetite", "Testdata1");
            const personalInfo5 = await Keywords.getattribute(Locatoronboard.LackofAppetite,"content-desc","3")
            await Keywords.verifyElementDisplayed(Locatoronboard.personalInformation(LackofAppetite), "Lack of AppetiteField");
            await Keywords.scrollToElement("accessibility id","CANCEL");
            const ShortnessField = await readData("TC_02", "Field", "Shortness", "Testdata1");
            const personalInfo6 = await Keywords.getattribute(Locatoronboard.Shortness,"content-desc","9")
            await Keywords.verifyElementDisplayed(Locatoronboard.personalInformation(ShortnessField), "Shortness Field");
            await Keywords.scrollToElement("accessibility id","CANCEL");
            const depressionFieldop = await readData("TC_02", "Field", "Depression", "Testdata1");
            const personalInfo7 = await Keywords.getattribute(Locatoronboard.depressionField,"content-desc","2")
            await Keywords.verifyElementDisplayed(Locatoronboard.personalInformation(depressionFieldop), " depression Field");
            await Keywords.scrollToElement("accessibility id","CANCEL");
            const Anxietyva = await readData("TC_02", "Field", "Anxiety", "Testdata1");
            const personalInfo8 = await Keywords.getattribute(Locatoronboard.AnxietyField,"content-desc","7")
            await Keywords.verifyElementDisplayed(Locatoronboard.personalInformation(Anxietyva), "Anxiety Field");

            await Keywords.scrollToElement("accessibility id","CANCEL");

            const WellbeingField = await readData("TC_02", "Field", "Wellbeing", "Testdata1");
            const personalInfo9= await Keywords.getattribute(Locatoronboard.WellbeingField,"content-desc","9")
            await Keywords.verifyElementDisplayed(Locatoronboard.personalInformation(WellbeingField), "Anxiety Field");
