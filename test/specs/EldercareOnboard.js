...
it('TC-005-NewUserOnboardingElderCare', async () => {
        try {
            ...
            await Keywords.verifyElementDisplayed(onboardLocator.whoisOnboarding, "Who is onboarding? Screen");
            await Keywords.click(onboardLocator.Eldernext, "Next Button");
            await Keywords.verifyElementDisplayed(onboardLocator.completeStatus(40), "40% onboard complete status")
            ...
            await Keywords.verifyElementDisplayed(onboardLocator.completeStatus(50), "50% onboard complete status");
            ...
            await Keywords.verifyElementDisplayed(onboardLocator.completeStatus(60), "60% onboard complete status");
            ...
            await Keywords.verifyElementDisplayed(onboardLocator.completeStatus(80), "80% onboard complete status");
