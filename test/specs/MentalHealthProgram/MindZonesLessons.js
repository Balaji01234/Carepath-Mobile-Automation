...
describe('Carepath Automation Mind Zone', () => {
    ...
    it('Lesson', async () => {
            ...
            await Keywords.click(locator.lessonContinueBtn,"Continue Button");
        ...
        await Keywords.click(locator.mindzone,"Mind zone");
            ...
            await Keywords.click(locator.lessonStartBtn,"Start Button")
        ...
        console.log('Login process completed successfully.');
           ...
           await Keywords.click(locator.lessonStartBtn,"Start Button")
            ...
            it('lesson four', async () => {
                ...
                await Keywords.verifyElementDisplayed(locator.loginpage, "Login screen")
                await Keywords.SetValue(locator.userName, process.env.USER_NAME);
                await Keywords.SetValue(locator.password, process.env.PASSWORD);
                if (!await locator.loginButton.isDisplayed()) {
                    await browser.hideKeyboard();
                }
                await Keywords.verifyElementDisplayed(locator.loginButton, "Login button")
                await Keywords.click(locator.loginButton, "Login Button")
                await Keywords.waitForDisplay(locator.getNotifiedDialogBox, 20000, "Get notified dialog box")
                await Keywords.click(locator.allowButton, "Allow button");
                await Keywords.waitForDisplay(locator.androidAllowNotification, 20000, "Default Allow notification")
                await Keywords.click(locator.androidAllowNotificationButton, "Default Allow notification button");
                ...
                await Keywords.click(locator.mindzone,"Mind zone");
                    ...
                    const Lesson4act = await readData("Mindzone", "Field", "LessonFour", "Testdata1");
                    const Lesson4actexp= await Keywords.getattribute(locator.lesson4Cared,"content-desc","Lesson 4: Managing Worry and Problem Solving")
                    expect(Lesson4act).to.equal(Lesson4actexp) 
                    await browser.pause(20000);
                    await Keywords.click(locator.lessonStartBtn,"Start Button")
                ...
                await browser.pause(9999);
                await locator.replayaction.isDisplayed({timeout:90000})
                const lessonfour1= await readData("Mindzone", "Field", "Audio", "Testdata1");
                ...
                await browser.pause(9999);
                await locator.replayaction.isDisplayed({timeout:90000})
                const lessonfour2= await readData("Mindzone", "Field", "Audio", "Testdata1");
                ...
                await Keywords.click(locator.playaction,"Play action");
                await browser.pause(9999);
                const lessonfour3= await readData("Mindzone", "Field", "Audio", "Testdata1");
                ...
                await browser.pause(9999);
                await locator.replayaction.isDisplayed({timeout:90000})
                const lessonfour4= await readData("Mindzone", "Field", "Audio", "Testdata1");
                ...
                await Keywords.click(locator.nextButton,"next");
                await Keywords.verifyElementDisplayed(locator.mindZoneCourseTitle, "Mind Zone Course Title")

                
            });
                it('lesson five', async () => {
                    allureReporter.addDescription(`
                        1. Click on the "Start Now" button.
                        2. Check if the login screen is displayed.
                        3. Enter the username and password.
                    ...
                    await Keywords.click(locator.mindzone,"Mind zone");
                        ...
                        const Lesson5act = await readData("Mindzone", "Field", "LessonFive", "Testdata1");
                        await browser.pause(20000);
                        const Lesson5actexp= await Keywords.getattribute(locator.lesson5Cared,"content-desc","Lesson 5: Working With Thoughts")
                        expect(Lesson5act).to.equal(Lesson5actexp) 
                        await browser.pause(20000);
                        //await Keywords.click(locator.lessonStartBtn,"Start Button")
                        //await Keywords.click(locator.clickReview, "Click Review Button");
                        await Keywords.click(locator.lessonContinueBtn,"Continue Button");
                    ...
                    await browser.pause(9999);
                    await locator.replayaction.isDisplayed({timeout:90000})
                    const lessonfive1= await readData("Mindzone", "Field", "Audio", "Testdata1");
                    ...
                    await browser.pause(9999);
                    await locator.replayaction.isDisplayed({timeout:90000})
                    const lessonfive2= await readData("Mindzone", "Field", "Audio", "Testdata1");
                    ...
                    await browser.pause(9999);
                    await locator.replayaction.isDisplayed({timeout:90000})
                    const lessonfive5= await readData("Mindzone", "Field", "Audio", "Testdata1");
                    ...
                    await browser.pause(9999);
                    await locator.replayaction.isDisplayed({timeout:90000})
                    const lessonfive6= await readData("Mindzone", "Field", "Audio", "Testdata1");
