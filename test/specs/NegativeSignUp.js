...
describe('Carepath Automation', async () => {
    ...
    for (let i = 0; i < iterationValue.length; i++) {
        it(`TC-004-Sign Up - Negative Iteration${iterationValue[i]}`, async () => {
            try {
                const role = await readData1("Signup-Positive", "TC_01", "Role", `Testdata${iterationValue[i]}`);
                allureReporter.addDescription(`New User Sign Up for: "${role} role" `)
                console.log(`Role: ${role}`)
                ...
                const studentText = await readData1("Signup-Positive", "TC_01", "StudentText", `Testdata${iterationValue[i]}`);
                const FirstName = `Prabha${getRandomString()}`
                await writeExcelData1("Signup-Negative", "TC_04", `Writedata${iterationValue[i]}`, "Firstname", FirstName);
                const LastName = (`Automation${getRandomString()}`).toLowerCase();
                await writeExcelData1("Signup-Negative", "TC_04", `Writedata${iterationValue[i]}`, "Lastname", LastName);
                const mail = `prabha${getRandomString() + generateRandomNumber()}@mailinator.com`;
                await writeExcelData1("Signup-Negative", "TC_04", `Writedata${iterationValue[i]}`, "Email", mail);
                const phoneNumber = await readData1("Signup-Positive", "TC_01", "Phone number", `Testdata${iterationValue[i]}`);
                const password = await readData1("Signup-Positive", "TC_01", "Password", `Testdata${iterationValue[i]}`);
                const employerName = await readData1("Signup-Positive", "TC_01", "Employer name", `Testdata${iterationValue[i]}`);
                const referral = await readData1("Signup-Positive", "TC_01", "Referrals", `Testdata${iterationValue[i]}`);
                ...
                const courseEnrolled = await readData1("Signup-Positive", "TC_01", "CourseEnrolled", `Testdata${iterationValue[i]}`);
                const program = await readData1("Signup-Positive", "TC_01", "Program", `Testdata${iterationValue[i]}`);
                const FirstNameErrorText = await readData1("Signup-Negative", "TC_04", "FirstNameErrorText", `Testdata${iterationValue[i]}`);
                const LastNameErrorText = await readData1("Signup-Negative", "TC_04", "LastNameErrorText", `Testdata${iterationValue[i]}`);
                const EmailIDErrorText = await readData1("Signup-Negative", "TC_04", "EmailIDErrorText", `Testdata${iterationValue[i]}`);
                const PhoneNumberErrorText = await readData1("Signup-Negative", "TC_04", "PhoneNumberErrorText", `Testdata${iterationValue[i]}`);
                const PasswordErrorText = await readData1("Signup-Negative", "TC_04", "PasswordErrorText", `Testdata${iterationValue[i]}`);
                const RepeatPasswordErrorText = await readData1("Signup-Negative", "TC_04", "RepeatPasswordErrorText", `Testdata${iterationValue[i]}`);
                const PasswordHint = await readData1("Signup-Negative", "TC_04", "PasswordHint", `Testdata${iterationValue[i]}`);
                const invalidFirstName = await readData1("Signup-Negative", "TC_04", "Firstname", `Testdata${iterationValue[i]}`);
                const invalidLastName = await readData1("Signup-Negative", "TC_04", "Lastname", `Testdata${iterationValue[i]}`);
                const invalidPhoneNumber = await readData1("Signup-Negative", "TC_04", "InvalidPhoneNumber", `Testdata${iterationValue[i]}`);
                const invalidPassword = await readData1("Signup-Negative", "TC_04", "InvalidPassword", `Testdata${iterationValue[i]}`);
                const invalidRepeatPassword = await readData1("Signup-Negative", "TC_04", "InvalidRepeatPassword", `Testdata${iterationValue[i]}`);
                const invalidEmail = await readData1("Signup-Negative", "TC_04", "Email", `Testdata${iterationValue[i]}`);
                const employerErrorText = await readData1("Signup-Negative", "TC_04", "EmployerNameErrorText", `Testdata${iterationValue[i]}`);
                const dobErrorText = await readData1("Signup-Negative", "TC_04", "DOBErrorText", `Testdata${iterationValue[i]}`);
                const studentDobErrorText = await readData1("Signup-Negative", "TC_04", "StudentDOBErrorText", `Testdata${iterationValue[i]}`);
                const referralErrorText = await readData1("Signup-Negative", "TC_04", "RefferalErrorText", `Testdata${iterationValue[i]}`);
                const invalidDOBbelow18 = await readData1("Signup-Negative", "TC_04", "InvalidDOBbelow18", `Testdata${iterationValue[i]}`);
                const invalidDOB = await readData1("Signup-Negative", "TC_04", "InvalidDOB", `Testdata${iterationValue[i]}`);
                const invalidOTP = await readData1("Signup-Negative", "TC_04", "InvalidOTP", `Testdata${iterationValue[i]}`);
                const invalidOTPError = await readData1("Signup-Negative", "TC_04", "InvalidOTPError", `Testdata${iterationValue[i]}`);
                const pinMustBe6DigitText = await readData1("Signup-Negative", "TC_04", "PinMustBe6DigitText", `Testdata${iterationValue[i]}`);
                const programNotToDisplay = await readData1("Signup-Negative", "TC_04", "ProgramNotToDisplay", `Testdata${iterationValue[i]}`);
                const programToDisplay = await readData1("Signup-Negative", "TC_04", "ProgramToDisplay", `Testdata${iterationValue[i]}`);
                const studentIDErrorText = await readData1("Signup-Negative", "TC_04", "StudentIDErrorText", `Testdata${iterationValue[i]}`);
                const courseEnrolledErrorText = await readData1("Signup-Negative", "TC_04", "CourseEnrolledErrorText", `Testdata${iterationValue[i]}`);
                const phoneNumberErrorStudent = await readData1("Signup-Negative", "TC_04", "PhoneNumberErrorStudent", `Testdata${iterationValue[i]}`);
                await Keywords.waitForDisplay(locator.startNow, 60000, "Start Now Button")
                await Keywords.verifyElementIsEnabled(locator.startNow, "Start Now Button")
                await Keywords.click(locator.startNow, "Start Now Button")
                await Keywords.verifyElementIsEnabled(locator.createAccountButton, "Create Account button");
